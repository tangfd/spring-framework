...
public abstract class AbstractBeanFactory extends FactoryBeanRegistrySupport implements ConfigurableBeanFactory {
	...
	protected <T> T doGetBean(final String name, @Nullable final Class<T> requiredType,
		...
		// 如果bean对象已经存在，则检查是否为工厂bean，如果是工厂bean，则返回代理的对象实例，否则返回此实例
		if (sharedInstance != null && args == null) {
			...
			try {
				...
				// 获取当前bean所依赖的所有bean的名称，保证当前bean所依赖的bean的初始化。
	...
	/**
	 * 确定具有给定名称的bean是否为工厂bean。
	 * bean是否实现了{@link FactoryBean}接口
	 *
	 ...
	 * 处理工厂bean，
	 * <ul>
	 * <li>如果不是工厂bean，则直接返回原bean实例，</li>
	 * <li>如果获取的对象就是工厂bean本身，则直接返回</li>
	 * <li>如果是工厂bean，返回工厂bean指定的bean对象实例本身</li>
	 * </ul>
	 * <p>
	...
	protected Object getObjectForBeanInstance(
		...
		if (object == null) {
			...
			// 调用工厂bean的getObject方法，获得指定的bean实例，并添加到工厂bean缓存中
